            ...
            <nav class="bg-light pt-2 pb-2 rounded" aria-label="breadcrumb">
              <ol class="breadcrumb d-flex align-items-center mb-0 px-2">
                <router-link to="/dshboard" class="breadcrumb-item"
                  >首頁</router-link
                >
                <router-link to="/staff" class="breadcrumb-item"
                  >人員管理</router-link
                >
                      ...
                      <form>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                          <div class="d-flex">
                            ...
                            >
                            <select
                              class="form-select col-auto mx-2"
                              aria-label="Default select example"
                            >
                              <option selected>選擇身分</option>
                              <option value="1">行銷人員</option>
                              <option value="2">一般人員</option>
                              <option value="3">最高管理員</option>
                            </select>
                          </div>
                        </div>
                        <!--  -->
                        ...
                        <!--  -->
                        <div class="col-12 fs-6 fw-bold mb-2 mt-4">
                          權限功能
                        </div>
                        <div class="row">
                          <div class="col-12">
                  ...
                  <div class="col-md-12 mb-4">
                    <div class="col-md-12">
                      ...
                      <form>
                        ...
                        <!--  -->
                        <div>
                          <h2 class="text-dark mt-4 fs-5 fw-bold">搜尋結果</h2>
                        </div>
                        <!--  -->
                        <div class="row card-group">
                          <div class="col-md-12 mb-4">
                            <div class="col-md-12">
                              ...
                              <!-- login form -->
                              <form
                                class="row fs-6 mt-4 p-4 border border-0 shadow rounded-4"
                              >
